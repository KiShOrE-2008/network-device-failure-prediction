...
Calculates an uncalibrated Anomaly Index (Deviation Score) representing relative
statistical deviation from the learned normal operational baseline.
"""
...
DEFAULT_BASELINE_STATS = {
    ...
    "CPU_Spike": {"mean": 0.0, "std": 0.2},
    "Temperature_Spike": {"mean": 0.0, "std": 0.2},
